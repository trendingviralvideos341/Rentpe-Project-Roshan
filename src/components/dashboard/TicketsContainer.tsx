...
export function TicketsContainer() {
    ...
    const handleEscalate = async (id: string) => {
        ...
        try { 
            await escalateTicketToAdmin(id); 
    ...
    if (loading) return (
        <div className="p-8 flex flex-col items-center justify-center min-h-[400px] space-y-4">
            ...
            <p className="text-muted-foreground font-medium text-xs tracking-widest uppercase text-center">Fetching Tickets...</p>
        </div>
    );
        ...
        <div className="space-y-6">
            <div className="flex items-center justify-between">
                <div>
                    ...
                    <p className="text-muted-foreground">Manage student complaints & raise issues to the RentPe Team.</p>
                </div>
