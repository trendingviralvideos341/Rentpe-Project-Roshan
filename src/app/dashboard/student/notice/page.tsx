...
import {
    ...
    ArrowLeft, XCircle, CalendarDays, Info, MessageSquare, Lock, FileDown, Eye
} from 'lucide-react';
...
export default function NoticePage() {
    ...
    const openStudentReceipt = async () => {
...
<div class='final'><span>${netRefund >= 0 ? '🏦 Refund Due to You' : '💰 Amount Paid to Owner'}</span><span class='amt'>₹${Math.abs(netRefund).toLocaleString('en-IN')}</span></div>
