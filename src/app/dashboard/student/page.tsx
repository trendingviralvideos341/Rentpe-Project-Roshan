    ...
    return (
        <div className="container mx-auto py-8 px-4 max-w-4xl">
            ...
            <Tabs value={activeTab} onValueChange={onTabChange} className="w-full">
                <TabsList className="grid w-full grid-cols-3 mb-8 p-1.5 bg-slate-100/80 rounded-2xl border shadow-inner h-auto">
                    <TabsTrigger value="bookings" className="rounded-xl data-[state=active]:bg-white data-[state=active]:text-indigo-700 data-[state=active]:shadow-md transition-all font-bold py-3 text-sm whitespace-nowrap">
                        <Calendar className="h-4 w-4 mr-2 hidden sm:block" /> My Bookings
                    </TabsTrigger>
                    <TabsTrigger value="payments" className="rounded-xl data-[state=active]:bg-white data-[state=active]:text-indigo-700 data-[state=active]:shadow-md transition-all font-bold py-3 text-sm whitespace-nowrap">
                        <CreditCard className="h-4 w-4 mr-2 hidden sm:block" /> Payments
                    </TabsTrigger>
                    <TabsTrigger value="profile" className="rounded-xl data-[state=active]:bg-white data-[state=active]:text-indigo-700 data-[state=active]:shadow-md transition-all font-bold py-3 text-sm whitespace-nowrap">
