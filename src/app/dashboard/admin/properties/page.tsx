            ...
            <div className="grid grid-cols-2 sm:grid-cols-4 lg:grid-cols-9 gap-4">
                {([
                    ...
                    <button
                        ...
                        className={`p-4 rounded-2xl border-[3px] flex flex-col gap-1 transition-all duration-300 text-left ${
                            filter === s.key 
                                ? "bg-indigo-600 border-indigo-700 shadow-none translate-y-1 translate-x-0.5 ring-4 ring-indigo-600/30" 
                                : `${s.bg} border-slate-950 shadow-[2px_2px_0px_0px_rgba(0,0,0,1)] hover:-translate-y-1 hover:shadow-[4px_4px_0px_0px_rgba(0,0,0,1)]`
                        }`}
                    >
