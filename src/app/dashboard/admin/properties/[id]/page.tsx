                            ...
                            <div className="p-6 space-y-4">
                                ...
                                <div className="p-4 bg-amber-50 rounded-2xl border border-amber-200">
                                    <p className="text-sm text-amber-800 font-medium leading-relaxed">
                                        ...
                                        ) : actionModal.type === 'verify_bank' ? (
                                            <>⚠️ You are verifying bank details for <span className="text-orange-600 font-bold">{p.name}</span> (<span className="text-orange-600 font-bold">{p.displayId}</span>). Make sure you have verified all details correctly before confirming. The next stage will move for <span className="text-orange-600 font-bold">Request Payment</span>.</>
