...
const STATUS_CONFIG: Record<string, { label: string; cls: string; icon: string }> = {
    PAID:    { label: 'Paid',    cls: 'bg-emerald-100 text-emerald-700 border-emerald-200', icon: '✅' },
    PENDING: { label: 'Pending', cls: 'bg-amber-100 text-amber-700 border-amber-200',     icon: '⏰' },
    PARTIAL: { label: 'Partial', cls: 'bg-blue-100 text-blue-700 border-blue-200',         icon: '🔵' },
    OVERDUE: { label: 'Overdue', cls: 'bg-red-100 text-red-700 border-red-200',            icon: '❌' },
};
                                                ...
                                                <tr key={inv.id} className="hover:bg-slate-50/50 transition-colors">
                                                    ...
                                                    <td className="px-5 py-4">
                                                        ...
                                                        {inv.paidAmount > 0 && inv.status !== 'PAID' && (
                                                            <p className="text-xs text-emerald-600">Paid: ₹{inv.paidAmount.toLocaleString('en-IN')}</p>
                                                        )}
                                                    </td>
